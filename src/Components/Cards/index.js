      ...
      <div className={classes.details}>
        ...
        <div>
          {props.SongBoolean == true && (
            ...
            //   Add to Playlist
            // </button>
            <AddToPlayList song={props.item} />
          )}
          {props.PlayListBoolean == true && (
            <button
              onClick={() =>
                props.deleteitem({ id: props.id, song: props.item })
              }
              style={{
                //   backgroundColor: "transperent",
                //   borderRadius: "5px",
...
const mapDispatchToProps = (dispatch) => ({
  deleteitem: (data) => dispatch(deleteSong(data)),
});
